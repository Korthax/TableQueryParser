...
{
    internal class GreaterThanOrEqualTo : IExpression
    {
        private readonly IValue _right;
        private readonly string _left;

        public GreaterThanOrEqualTo(string left, IValue right)
        {
            _left = left;
            _right = right;
        }
        ...
        public bool Resolve<T>(T testObject, List<IExpression> expressions)
        {
            ...
            return _right.LessThan(t.GetValue(testObject)) || _right.EqualTo(t.GetValue(testObject));
        }
